...
@admin_password_router.message(Command(BotCommands.PASSWORD_MENU.command), IsAdmin())
...
@admin_password_router.callback_query(PasswordAction.filter(F.action == PasswordAction.ActionType.CHANGE))
...
@admin_password_router.callback_query(PasswordAction.filter(F.action == PasswordAction.ActionType.DELETE))
